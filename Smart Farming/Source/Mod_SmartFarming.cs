...
namespace SmartFarming
{
    ...
    public class Mod_SmartFarming : Mod
	{
		...
		public override void DoSettingsWindowContents(Rect inRect)
		{
			...
			options.CheckboxLabeled("SmartFarming.Settings.OldPatchMethod".Translate(), ref oldPatchMethod, "SmartFarming.Settings.OldPatchMethod.Desc".Translate());
			...
			options.Gap();
			options.Label(label:"SmartFarming.Settings.MinTempSlider".Translate("-3C", "-10C", "5C") + Math.Round(minTempAllowed, 1), maxHeight:-1f, tooltip:"SmartFarming.Settings.MinTemp".Translate());
	...
	public class ModSettings_SmartFarming : ModSettings
	{
		public override void ExposeData()
		{
			...
			Scribe_Values.Look(ref oldPatchMethod, "oldPatchMethod", false);

			base.ExposeData();
		}

		public static bool oldPatchMethod = false;
		public static bool useAverageFertility, autoCutBlighted = true, autoCutDying = true, logging, coldSowing = true, autoHarvestNow = true, allowHarvestOption, orchardAlignment = true;
