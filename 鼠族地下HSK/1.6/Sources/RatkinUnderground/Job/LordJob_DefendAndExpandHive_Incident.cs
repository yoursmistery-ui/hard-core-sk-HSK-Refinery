...
{
    public class LordJob_DefendAndExpandHive_Incident : LordJob
    {
        ...
        public LordJob_DefendAndExpandHive_Incident()
        {
        }

        public LordJob_DefendAndExpandHive_Incident(SpawnedPawnParams parms)
        {
